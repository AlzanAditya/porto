  ...
  const defaultItems: ServiceItem[] = [
    {
      ...
      tags:
        lang === "id"
          ? ["React & Next.js", "Arsitektur Full-Stack", "UI/UX Responsif", "Performa & SEO", "Desain Database"]
          : ["React & Next.js", "Full-Stack Architecture", "Responsive UI/UX", "Performance & SEO", "Database Design"],
    ...
    },
    {
      ...
      tags:
        lang === "id"
          ? ["REST & GraphQL API", "Autentikasi & Keamanan", "Integrasi Pihak Ketiga", "Optimasi Database"]
          : ["REST & GraphQL APIs", "Auth & Security", "Third-Party Integrations", "Database Optimization"],
      image: "/assets/backend-api.jpeg",
    },
    {
      number: "03.",
      ...
      tags:
        lang === "id"
          ? ["Desain Berpusat Pengguna", "Wireframing & Prototyping", "Design System", "Aksesibilitas (a11y)"]
          : ["User-Centered Design", "Wireframing & Prototyping", "Design Systems", "Accessibility (a11y)"],
      image: "/assets/uiux-design.jpeg",
    },
    {
      number: "04.",
      ...
      tags:
        lang === "id"
          ? ["Audit Kode & Refactoring", "Kecepatan & Optimasi Core Web Vitals", "Pembersihan SEO & Metadata", "Skalabilitas"]
          : ["Code Auditing & Refactor", "Core Web Vitals Speed", "Technical SEO Cleanup", "Scalability Optimization"],
      image: "/assets/optimization.jpeg",
    },
  ];
