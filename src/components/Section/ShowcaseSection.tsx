...
export const ShowcaseCover: React.FC<ShowcaseCoverProps> = ({
  ...
  return (
    <div
      className={`absolute inset-0 grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 p-4 opacity-40 hover:opacity-70 transition-opacity duration-500 ${className}`}
    >
...
export const ShowcaseCta: React.FC<ShowcaseCtaProps> = ({
  ...
  return (
    <div
      className={`showcase-modal w-full max-w-sm md:max-w-md p-6 md:p-8 flex flex-col justify-between shadow-2xl bg-white/95 backdrop-blur-md rounded-2xl border border-white/80 ${className}`}
    >
