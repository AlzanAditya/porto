...
export const projectsData: Project[] = [
  {
    ...
    overview:
      "YOBSS (Your Business System) adalah platform business management modular yang dirancang untuk membantu perusahaan mengelola berbagai proses bisnis dan operasional dalam satu sistem yang terstruktur. Sistem ini dapat dikembangkan dan disesuaikan dengan kebutuhan perusahaan, mencakup pengelolaan aset, operasional, maintenance, inventory, workforce, reporting, hingga berbagai workflow bisnis lainnya.\n\nYOBSS juga menerapkan role-based access yang memisahkan pengalaman dan tanggung jawab setiap pengguna, seperti Admin untuk mengelola sistem dan data perusahaan, Worker untuk menjalankan pekerjaan operasional yang ditugaskan, serta Customer untuk mengakses informasi dan layanan yang berkaitan dengan mereka. Dengan arsitektur yang modular dan workflow yang terintegrasi, YOBSS dapat menjadi fondasi business system yang fleksibel dan dapat diadaptasi untuk berbagai jenis perusahaan dan kebutuhan operasional.",
    overview_id:
      "YOBSS (Your Business System) adalah platform business management modular yang dirancang untuk membantu perusahaan mengelola berbagai proses bisnis dan operasional dalam satu sistem yang terstruktur. Sistem ini dapat dikembangkan dan disesuaikan dengan kebutuhan perusahaan, mencakup pengelolaan aset, operasional, maintenance, inventory, workforce, reporting, hingga berbagai workflow bisnis lainnya.\n\nYOBSS juga menerapkan role-based access yang memisahkan pengalaman dan tanggung jawab setiap pengguna, seperti Admin untuk mengelola sistem dan data perusahaan, Worker untuk menjalankan pekerjaan operasional yang ditugaskan, serta Customer untuk mengakses informasi dan layanan yang berkaitan dengan mereka. Dengan arsitektur yang modular dan workflow yang terintegrasi, YOBSS dapat menjadi fondasi business system yang fleksibel dan dapat diadaptasi untuk berbagai jenis perusahaan dan kebutuhan operasional.",
    overview_en:
      "YOBSS (Your Business System) is a modular business management platform designed to help companies manage diverse business and operational processes within a single, structured system. This system can be scaled and tailored to enterprise needs, encompassing asset management, operations, maintenance, inventory, workforce, reporting, and various other business workflows.\n\nYOBSS also implements role-based access to separate the experience and responsibilities of each user, such as Admin to manage corporate systems and data, Worker to perform assigned operational tasks, and Customer to access relevant information and services. With a modular architecture and integrated workflows, YOBSS serves as a flexible business system foundation that can be adapted for diverse company types and operational demands.",
